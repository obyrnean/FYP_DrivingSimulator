...
public class Scene41Controller : MonoBehaviour
{
    [Header("UI")]
    ...
    void EndScene()
    {
        StartCoroutine(FadeOutAndGoToScene42()); // NEXT SCENE
    }

    IEnumerator FadeOutAndGoToScene42() // NEXT SCENE
    {
        float t = 0f;
        ...
        if (panelManager != null)
            panelManager.GoToScene42(); //NEXT SCENE
    }
}