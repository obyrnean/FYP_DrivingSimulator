...
public class Scene25Controller : MonoBehaviour
{
    [Header("UI")]
    ...
    void EndScene()
    {
        StartCoroutine(FadeOutAndGoToScene26()); // NEXT SCENE
    }

    IEnumerator FadeOutAndGoToScene26() // NEXT SCENE
    {
        float t = 0f;
        ...
        if (panelManager != null)
            panelManager.GoToScene26(); //NEXT SCENE
    }
}