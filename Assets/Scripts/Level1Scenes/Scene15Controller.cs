...
public class Scene15Controller : MonoBehaviour
{
    [Header("UI")]
    ...
    public class DialogueStep
    {
        ...
        public string[] buttonTexts; // Default option texts
    ...
    void EndScene()
    {
        StartCoroutine(FadeOutAndGoToScene16());
    }

    IEnumerator FadeOutAndGoToScene16()
    {
        float t = 0f;
        while (t < dialogueFadeDuration)
        {
