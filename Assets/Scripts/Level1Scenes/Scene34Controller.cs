...
public class Scene34Controller : MonoBehaviour
{
    [Header("UI")]
    ...
    void EndScene()
    {
        StartCoroutine(FadeOutAndGoToScene35()); // NEXT SCENE
    }

    IEnumerator FadeOutAndGoToScene35() // NEXT SCENE
    {
        float t = 0f;
        ...
        if (panelManager != null)
            panelManager.GoToScene35(); //NEXT SCENE
    }
}