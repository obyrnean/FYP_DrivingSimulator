...
public class Scene26Controller : MonoBehaviour
{
    [Header("UI")]
    ...
    void EndScene()
    {
        StartCoroutine(FadeOutAndGoToScene27()); // NEXT SCENE
    }

    IEnumerator FadeOutAndGoToScene27() // NEXT SCENE
    {
        float t = 0f;
        ...
        if (panelManager != null)
            panelManager.GoToScene27(); //NEXT SCENE
    }
}