...
public class Scene29Controller : MonoBehaviour
{
    [Header("UI")]
    ...
    void OnOptionClicked(int index)
    {
        ...
        {
            StartCoroutine(FadeOutAndGoToScene30());
        }
        else
        {
            StartCoroutine(FadeOutAndGoToScene30_2());
        }
    }
    ...
    IEnumerator FadeOutAndGoToScene30()
    {
        float t = 0f;
        ...
        if (panelManager != null)
            panelManager.GoToScene30();
    }

    IEnumerator FadeOutAndGoToScene30_2()
    {
        float t = 0f;
