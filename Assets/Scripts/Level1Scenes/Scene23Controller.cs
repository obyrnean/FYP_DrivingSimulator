...
public class Scene23Controller : MonoBehaviour
{
    [Header("UI")]
    ...
    void EndScene()
    {
        StartCoroutine(FadeOutAndGoToScene24()); // NEXT SCENE
    }

    IEnumerator FadeOutAndGoToScene24() // NEXT SCENE
    {
        float t = 0f;
        ...
        if (panelManager != null)
            panelManager.GoToScene24(); //NEXT SCENE
    }
}