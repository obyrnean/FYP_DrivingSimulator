...
public class Scene28Controller : MonoBehaviour
{
    [Header("UI")]
    ...
    void EndScene()
    {
        StartCoroutine(FadeOutAndGoToScene29()); // NEXT SCENE
    }

    IEnumerator FadeOutAndGoToScene29() // NEXT SCENE
    {
        float t = 0f;
        ...
        if (panelManager != null)
            panelManager.GoToScene29(); //NEXT SCENE
    }
}