...
public class Scene18Controller : MonoBehaviour
{
    [Header("UI")]
    ...
    void EndScene()
    {
        StartCoroutine(FadeOutAndGoToScene19()); // NEXT SCENE
    }

    IEnumerator FadeOutAndGoToScene19() // NEXT SCENE
    {
        float t = 0f;
        ...
        if (panelManager != null)
            panelManager.GoToScene19(); //NEXT SCENE
    }
}