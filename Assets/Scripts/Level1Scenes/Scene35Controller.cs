...
public class Scene35Controller : MonoBehaviour
{
    [Header("UI")]
    ...
    void EndScene()
    {
        StartCoroutine(FadeOutAndGoToScene36()); // NEXT SCENE
    }

    IEnumerator FadeOutAndGoToScene36() // NEXT SCENE
    {
        float t = 0f;
        ...
        if (panelManager != null)
            panelManager.GoToScene36(); //NEXT SCENE
    }
}