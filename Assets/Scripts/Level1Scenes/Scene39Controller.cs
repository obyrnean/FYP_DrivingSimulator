...
public class Scene39Controller : MonoBehaviour
{
    [Header("UI")]
    ...
    void EndScene()
    {
        StartCoroutine(FadeOutAndGoToScene40()); // NEXT SCENE
    }

    IEnumerator FadeOutAndGoToScene40() // NEXT SCENE
    {
        float t = 0f;
        ...
        if (panelManager != null)
            panelManager.GoToScene40(); //NEXT SCENE
    }
}