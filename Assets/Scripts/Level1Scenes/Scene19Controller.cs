...
public class Scene19Controller : MonoBehaviour
{
    [Header("UI")]
    ...
    void EndScene()
    {
        StartCoroutine(FadeOutAndGoToScene20()); // NEXT SCENE
    }

    IEnumerator FadeOutAndGoToScene20() // NEXT SCENE
    {
        float t = 0f;
        ...
        if (panelManager != null)
            panelManager.GoToScene20(); //NEXT SCENE
    }
}