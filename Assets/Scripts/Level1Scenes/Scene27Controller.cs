...
public class Scene27Controller : MonoBehaviour
{
    [Header("UI")]
    ...
    void EndScene()
    {
        StartCoroutine(FadeOutAndGoToScene28()); // NEXT SCENE
    }

    IEnumerator FadeOutAndGoToScene28() // NEXT SCENE
    {
        float t = 0f;
        ...
        if (panelManager != null)
            panelManager.GoToScene28(); //NEXT SCENE
    }
}