...
public class Scene21_1Controller : MonoBehaviour
{
    [Header("UI")]
    ...
    void EndScene()
    {
        StartCoroutine(FadeOutAndGoToScene21_2()); // NEXT SCENE
    }

    IEnumerator FadeOutAndGoToScene21_2() // NEXT SCENE
    {
        float t = 0f;
        ...
        if (panelManager != null)
            panelManager.GoToScene21_2(); //NEXT SCENE
    }
}