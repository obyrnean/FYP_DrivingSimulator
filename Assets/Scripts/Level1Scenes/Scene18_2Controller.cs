...
public class Scene18_2Controller : MonoBehaviour
{
    [Header("UI")]
    ...
    {
        // Stop any running coroutines (revisiting)
    ...
    void EndScene()
    {
        StartCoroutine(FadeOutAndGoToScene19_2()); // NEXT SCENE
    }

    IEnumerator FadeOutAndGoToScene19_2() // NEXT SCENE
    {
        float t = 0f;
        ...
        if (panelManager != null)
            panelManager.GoToScene19_2(); //NEXT SCENE
    }
}