...
public class Scene16Controller : MonoBehaviour
{
    [Header("UI")]
    ...
    void EndScene()
    {
        StartCoroutine(FadeOutAndGoToScene17()); // NEXT SCENE
    }

    IEnumerator FadeOutAndGoToScene17() // NEXT SCENE
    {
        float t = 0f;
        ...
        if (panelManager != null)
            panelManager.GoToScene17(); //NEXT SCENE
    }
}