...
public class Scene38Controller : MonoBehaviour
{
    [Header("UI")]
    ...
    void EndScene()
    {
        StartCoroutine(FadeOutAndGoToScene39()); // NEXT SCENE
    }

    IEnumerator FadeOutAndGoToScene39() // NEXT SCENE
    {
        float t = 0f;
        ...
        if (panelManager != null)
            panelManager.GoToScene39(); //NEXT SCENE
    }
}