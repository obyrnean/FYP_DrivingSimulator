...
public class Scene17Controller : MonoBehaviour
{
    [Header("UI")]
    ...
    void OnOptionClicked(int index)
    {
        ...
        {
            StartCoroutine(FadeOutAndGoToScene18());
        }
        else
        {
            StartCoroutine(FadeOutAndGoToScene18_2());
        }
    }
    ...
    IEnumerator FadeOutAndGoToScene18()
    {
        float t = 0f;
        ...
        if (panelManager != null)
            panelManager.GoToScene18();
    }

    IEnumerator FadeOutAndGoToScene18_2()
    {
        float t = 0f;
