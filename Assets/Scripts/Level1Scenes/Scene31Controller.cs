...
public class Scene31Controller : MonoBehaviour
{
    [Header("UI")]
    ...
    void EndScene()
    {
        StartCoroutine(FadeOutAndGoToScene32()); // NEXT SCENE
    }

    IEnumerator FadeOutAndGoToScene32() // NEXT SCENE
    {
        float t = 0f;
        ...
        if (panelManager != null)
            panelManager.GoToScene32(); //NEXT SCENE
    }
}