...
public class Scene13_2Controller : MonoBehaviour
{
    [Header("UI")]
    ...
    // Runs EVERY time panel becomes active
    ...
    void EndScene()
    {
        StartCoroutine(FadeOutAndGoToScene12());
    }

    IEnumerator FadeOutAndGoToScene12()
    {
        float t = 0f;
