...
public class Scene12Controller : MonoBehaviour
{
    ...
    void OnOptionClicked(int index)
    {
        ...
        {
            StartCoroutine(FadeOutAndGoToScene13());
        }
        else
        {
            StartCoroutine(FadeOutAndGoToScene13_2());
        }
    }
    ...
    IEnumerator FadeOutAndGoToScene13()
    {
        float t = 0f;
        ...
        if (panelManager != null)
            panelManager.GoToScene13();
    }

    IEnumerator FadeOutAndGoToScene13_2()
    {
        float t = 0f;
