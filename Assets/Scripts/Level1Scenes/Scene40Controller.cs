...
public class Scene40Controller : MonoBehaviour
{
    [Header("UI")]
    ...
    void EndScene()
    {
        StartCoroutine(FadeOutAndGoToScene41()); // NEXT SCENE
    }

    IEnumerator FadeOutAndGoToScene41() // NEXT SCENE
    {
        float t = 0f;
        ...
        if (panelManager != null)
            panelManager.GoToScene41(); //NEXT SCENE
    }
}