...
public class Scene22Controller : MonoBehaviour
{
    [Header("UI")]
    ...
    void EndScene()
    {
        StartCoroutine(FadeOutAndGoToScene23()); // NEXT SCENE
    }

    IEnumerator FadeOutAndGoToScene23() // NEXT SCENE
    {
        float t = 0f;
        ...
        if (panelManager != null)
            panelManager.GoToScene23(); //NEXT SCENE
    }
}