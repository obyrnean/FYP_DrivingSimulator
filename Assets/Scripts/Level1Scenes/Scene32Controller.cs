...
public class Scene32Controller : MonoBehaviour
{
    ...
    void OnOptionClicked(int index)
    {
        ...
        if (index == 0)
        {
            StartCoroutine(FadeOutAndGoToScene33());
        }
        else if (index == 1)
        {
            StartCoroutine(FadeOutAndGoToScene33_2());
        }
        else if (index == 2)
        {
            StartCoroutine(FadeOutAndGoToScene33_3());
        }
    }
    ...
    IEnumerator FadeOutAndGoToScene33()
    {
        float t = 0f;
        ...
        if (panelManager != null)
            panelManager.GoToScene33();
    }

    IEnumerator FadeOutAndGoToScene33_2()
    {
        float t = 0f;
        ...
        if (panelManager != null)
            panelManager.GoToScene33_2();
    }


    IEnumerator FadeOutAndGoToScene33_3()
    {
        float t = 0f;
